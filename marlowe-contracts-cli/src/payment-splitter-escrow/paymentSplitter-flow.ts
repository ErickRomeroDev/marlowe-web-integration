...
export async function createContractMenu(
  ...
  const additional1 = addressBech32(
    await input({
      message: "Enter additional recepient #1",
      validate: bech32Validator,
    })
  );
  const additional2 = addressBech32(
    await input({
      message: "Enter additional recepient #2",
      validate: bech32Validator,
    })
  );
  const additional3 = addressBech32(
    await input({
      message: "Enter additional recepient #3",
      validate: bech32Validator,
    })
  );
  const additional4 = addressBech32(
    await input({
      message: "Enter additional recepient #4",
      validate: bech32Validator,
    })
  );
  const additional5 = addressBech32(
    await input({
      message: "Enter additional recepient #5",
      validate: bech32Validator,
    })
  );
  const additional6 = addressBech32(
    await input({
