...
declare const projectTemplate: import("@marlowe.io/marlowe-template").MarloweTemplate<{
    ...
    projectName: string;
    githubUrl: string;
    payee2: t.Branded<string, import("@marlowe.io/runtime-core").AddressBech32Brand>;
    payee3: t.Branded<string, import("@marlowe.io/runtime-core").AddressBech32Brand>;
    payee4: t.Branded<string, import("@marlowe.io/runtime-core").AddressBech32Brand>;
    payee5: t.Branded<string, import("@marlowe.io/runtime-core").AddressBech32Brand>;
    payee6: t.Branded<string, import("@marlowe.io/runtime-core").AddressBech32Brand>;
    payee7: t.Branded<string, import("@marlowe.io/runtime-core").AddressBech32Brand>;
}>;
...
export {};
//# sourceMappingURL=paymentSplitter.d.ts.map