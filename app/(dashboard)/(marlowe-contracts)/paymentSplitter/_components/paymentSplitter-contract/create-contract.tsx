...
import { ProjectParameters } from "@/lib/contracts-ui/paymentSplitter";
...
export const CreateContract = () => {
  ...
  const deploy = async (amount: number,    
    ...
    const { mkContract } = await import("@/lib/contracts-ui/paymentSplitter");
    if (walletAddress && runtimeLifecycle) {
      try {
        ...
        const schema: ProjectParameters = {
          ...
          auditor: walletAddress as AddressBech32,
